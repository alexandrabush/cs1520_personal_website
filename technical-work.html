  	...
  	<div class="container">
	  	<div class="row">
	  		...
	  		<div class="column-md-9" style="padding-left: 200px; padding-top:30px">
	  			<h1> Here are some of my favorite technical projects. </h1>
	  		</div>
	   	</div>
	   	...
	   	<div class="row">
    		<div class="col-sm-2" style="padding-top:20px">
   		  ...
   		  <div class="col-sm-10" style="padding-top: 20px" >
      		<p style="font-size:130%;"> The best way to check out my technical work is to follow me on GitHub! I also have a BitBucket account you can check out. </p>  
    		</div>
		  </div>
  	</div>
